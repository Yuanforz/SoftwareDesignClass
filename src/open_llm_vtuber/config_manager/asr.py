...
class FunASRConfig(I18nMixin):
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "device": Description(
            en="Device to use for inference (cpu, cuda, cuda:0, etc.)", zh="推理设备（cpu、cuda、cuda:0 等）"
        ),
        ...
        "cache_dir": Description(
            en="Directory to cache downloaded models",
            zh="模型缓存目录",
        ),
        "use_itn": Description(
